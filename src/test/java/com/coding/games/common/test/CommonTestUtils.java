package com.coding.games.common.test;

public class CommonTestUtils {
	
	public static final String LONG_GENERIC_TEXT = new StringBuilder("Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do")
